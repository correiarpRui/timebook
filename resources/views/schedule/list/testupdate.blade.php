...
@section('content')
    <div class="p-6">
        <div class="flex items-center gap-1">
            ...
            <a href="{{ route('schedule.update', $schedule->id) }}">Update schedule</a>
        </div>
        <form action="{{ route('schedule.patch', $schedule->id) }}" method="POST" class="grid grid-cols-2 gap-2 ">
            @csrf
            @method('PATCH')
                ...
                <div class="py-2 flex flex-col gap-5">
                    <div class="px-5 mt-2 flex items-center">
                        ...
                        <div class="flex flex-col grow">
                            <input
                                ...
                                type="text" name="name" value="{{ $schedule->name }}">
                            @error('name')
                    ...
                    <div class="px-5 flex items-center">
                        ...
                        <div class="flex flex-col grow">
                            <input
                                class="bg-transparent text-[#6b6f80] border border-[#e2e4ef] rounded-md h-[42px] px-3 py-1 focus:outline-none focus:border-[#9aa0ac] w-full"
                                type="time" name="morning_start" value="{{ $schedule->morning_start }}">
                            @error('morning_start')
                                <div class="flex h-[24px] text-[#dc3838] items-center justify-start text-sm gap-1 pl-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14"
                                        class=" flex-shrink-0 w-[16px] h-[16px]">
                    ...
                    <div class="px-5 flex items-center">
                        ...
                        <div class="flex flex-col grow">
                            <input
                                class="bg-transparent text-[#6b6f80] border border-[#e2e4ef] rounded-md h-[42px] px-3 py-1 focus:outline-none focus:border-[#9aa0ac] w-full"
                                type="time" name="morning_end" value="{{ $schedule->morning_end }}">
                            @error('morning_end')
                                <div class="flex h-[24px] text-[#dc3838] items-center justify-start text-sm gap-1 pl-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14"
                                        class=" flex-shrink-0 w-[16px] h-[16px]">
                    ...
                    <div class="px-5 flex items-center">
                        ...
                        <div class="flex flex-col grow">
                            <input
                                class="bg-transparent text-[#6b6f80] border border-[#e2e4ef] rounded-md h-[42px] px-3 py-1 focus:outline-none focus:border-[#9aa0ac] w-full"
                                type="time" name="afternoon_start" value="{{ $schedule->afternoon_start }}">
                    ...
                    <div class="px-5 mb-2 flex items-center">
                        ...
                        <div class="flex flex-col grow">
                            <input
                                class="bg-transparent text-[#6b6f80] border border-[#e2e4ef] rounded-md h-[42px] px-3 py-1 focus:outline-none focus:border-[#9aa0ac] w-full"
                                type="time" name="afternoon_end" value="{{ $schedule->afternoon_end }}">
                            @error('afternoon_end')
                                <div class="flex h-[24px] text-[#dc3838] items-center justify-start text-sm gap-1 pl-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14"
                                        class=" flex-shrink-0 w-[16px] h-[16px]">
                ...
                <div class="px-5 py-2 flex items-center flex-col">
                    <div class="flex mb-3 mt-2 py-2 px-6 border rounded-md justify-between w-full items-center">
                        ...
                        <button id="monday" onclick=toggleCheckboxButton(this) type="button"
                            class="h-5 w-9 bg-[#CBCFD2] rounded-full border-2 border-transparent duration-[0.15s] {{ $schedule->monday ? 'buttonActive' : '' }}">
                            <span id="span_monday"
                                class="bg-white rounded-full h-4 w-4 block duration-[0.15s] checkbox {{ $schedule->monday ? 'checkboxActive' : '' }}"></span>
                        </button>
                    ...
                    <div class="flex mb-3 mt-2 py-2 px-6 border rounded-md justify-between w-full items-center">
                        ...
                        <button id="tuesday" onclick=toggleCheckboxButton(this) type="button"
                            class="h-5 w-9 bg-[#CBCFD2] rounded-full border-2 border-transparent duration-[0.15s] {{ $schedule->tuesday ? 'buttonActive' : '' }}">
                            <span id="span_tuesday"
                                class="bg-white rounded-full h-4 w-4 block duration-[0.15s] checkbox {{ $schedule->tuesday ? 'checkboxActive' : '' }}"></span>
                        </button>
                    ...
                    <div class="flex mb-3 mt-2 py-2 px-6 border rounded-md justify-between w-full items-center">
                        ...
                        <button id="wednesday" onclick=toggleCheckboxButton(this) type="button"
                            class="h-5 w-9 bg-[#CBCFD2] rounded-full border-2 border-transparent duration-[0.15s] {{ $schedule->wednesday ? 'buttonActive' : '' }}">
                            <span id="span_wednesday"
                                class="bg-white rounded-full h-4 w-4 block duration-[0.15s] checkbox {{ $schedule->wednesday ? 'checkboxActive' : '' }}"></span>
                        </button>
                    ...
                    <div class="flex mb-3 mt-2 py-2 px-6 border rounded-md justify-between w-full items-center">
                        ...
                        <button id="thursday" onclick=toggleCheckboxButton(this) type="button"
                            class="h-5 w-9 bg-[#CBCFD2] rounded-full border-2 border-transparent duration-[0.15s] {{ $schedule->thursday ? 'buttonActive' : '' }}">
                            <span id="span_thursday"
                                class="bg-white rounded-full h-4 w-4 block duration-[0.15s] checkbox {{ $schedule->thursday ? 'checkboxActive' : '' }}"></span>
                        </button>
                    ...
                    <div class="flex mb-3 mt-2 py-2 px-6 border rounded-md justify-between w-full items-center">
                        ...
                        <button id="friday" onclick=toggleCheckboxButton(this) type="button"
                            class="h-5 w-9 bg-[#CBCFD2] rounded-full border-2 border-transparent duration-[0.15s] {{ $schedule->friday ? 'buttonActive' : '' }}">
                            <span id="span_friday"
                                class="bg-white rounded-full h-4 w-4 block duration-[0.15s] checkbox {{ $schedule->friday ? 'checkboxActive' : '' }}"></span>
                        </button>
                    ...
                    <div class="flex mb-3 mt-2 py-2 px-6 border rounded-md justify-between w-full items-center">
                        ...
                        <button id="saturday" onclick=toggleCheckboxButton(this) type="button"
                            class="h-5 w-9 bg-[#CBCFD2] rounded-full border-2 border-transparent duration-[0.15s] {{ $schedule->saturday ? 'buttonActive' : '' }}">
                            <span id="span_saturday"
                                class="bg-white rounded-full h-4 w-4 block duration-[0.15s] checkbox {{ $schedule->saturday ? 'checkboxActive' : '' }}"></span>
                        </button>
                    ...
                    <div class="flex mb-3 mt-2 py-2 px-6 border rounded-md justify-between w-full items-center">
                        ...
                        <button id="sunday" onclick=toggleCheckboxButton(this) type="button"
                            class="h-5 w-9 bg-[#CBCFD2] rounded-full border-2 border-transparent duration-[0.15s] {{ $schedule->sunday ? 'buttonActive' : '' }}">
                            <span id="span_sunday"
                                class="bg-white rounded-full h-4 w-4 block duration-[0.15s] checkbox {{ $schedule->sunday ? 'checkboxActive' : '' }}"></span>
                        </button>
