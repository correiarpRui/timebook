...
@section('content')
    <div class="text-[#fafafa]">
        ...
        <div class="p-6">
            ...
            <form action="{{ route('schedule.patch', $schedule->id) }}" method="POST" class="flex flex-col gap-4">
                @csrf
                @method('PATCH')
                ...
                <div>
                    <div class="flex mb-3 py-4 px-6 border border-[#27272a] rounded-md justify-between select-none">
                        ...
                        <button id="monday" onclick=toggleCheckboxButton(this) type="button"
                            class="h-5 w-9 bg-[#27272a] rounded-full border-2 border-transparent duration-[0.15s] {{ $schedule->monday ? 'buttonActive' : '' }}">
                            <span id="span_monday"
                                class="bg-[#09090b] rounded-full h-4 w-4 block duration-[0.15s] {{ $schedule->monday ? 'checkboxActive' : '' }}"></span>
                        </button>
                    ...
                    <div class="flex mb-3 py-4 px-6 border border-[#27272a] rounded-md justify-between select-none">
                        ...
                        <button id="tuesday" onclick=toggleCheckboxButton(this) type="button"
                            class="h-5 w-9 bg-[#27272a] rounded-full border-2 border-transparent duration-[0.15s] {{ $schedule->tuesday ? 'buttonActive' : '' }}">
                            <span id="span_tuesday"
                                class="bg-[#09090b] rounded-full h-4 w-4 block duration-[0.15s] {{ $schedule->tuesday ? 'checkboxActive' : '' }}"></span>
                        </button>
                    ...
                    <div class="flex mb-3 py-4 px-6 border border-[#27272a] rounded-md justify-between select-none">
                        ...
                        <button id="wednesday" onclick=toggleCheckboxButton(this) type="button"
                            class="h-5 w-9 bg-[#27272a] rounded-full border-2 border-transparent duration-[0.15s] {{ $schedule->wednesday ? 'buttonActive' : '' }}">
                            <span id="span_wednesday"
                                class="bg-[#09090b] rounded-full h-4 w-4 block duration-[0.15s] {{ $schedule->wednesday ? 'checkboxActive' : '' }}"></span>
                        </button>
                    ...
                    <div class="flex mb-3 py-4 px-6 border border-[#27272a] rounded-md justify-between select-none">
                        ...
                        <button id="thursday" onclick=toggleCheckboxButton(this) type="button"
                            class="h-5 w-9 bg-[#27272a] rounded-full border-2 border-transparent duration-[0.15s] {{ $schedule->thursday ? 'buttonActive' : '' }}">
                            <span id="span_thursday"
                                class="bg-[#09090b] rounded-full h-4 w-4 block duration-[0.15s] {{ $schedule->thursday ? 'checkboxActive' : '' }}"></span>
                        </button>
                    ...
                    <div class="flex mb-3 py-4 px-6 border border-[#27272a] rounded-md justify-between select-none">
                        ...
                        <button id="friday" onclick=toggleCheckboxButton(this) type="button"
                            class="h-5 w-9 bg-[#27272a] rounded-full border-2 border-transparent duration-[0.15s] {{ $schedule->friday ? 'buttonActive' : '' }}">
                            <span id="span_friday"
                                class="bg-[#09090b] rounded-full h-4 w-4 block duration-[0.15s] {{ $schedule->friday ? 'checkboxActive' : '' }}"></span>
                        </button>
                    ...
                    <div class="flex mb-3 py-4 px-6 border border-[#27272a] rounded-md justify-between select-none">
                        ...
                        <button id="saturday" onclick=toggleCheckboxButton(this) type="button"
                            class="h-5 w-9 bg-[#27272a] rounded-full border-2 border-transparent duration-[0.15s] {{ $schedule->saturday ? 'buttonActive' : '' }}">
                            <span id="span_saturday"
                                class="bg-[#09090b] rounded-full h-4 w-4 block duration-[0.15s] {{ $schedule->saturday ? 'checkboxActive' : '' }}"></span>
                        </button>
                    ...
                    <div class="flex mb-3 py-4 px-6 border border-[#27272a] rounded-md justify-between select-none">
                        ...
                        <button id="sunday" onclick=toggleCheckboxButton(this) type="button"
                            class="h-5 w-9 bg-[#27272a] rounded-full border-2 border-transparent duration-[0.15s] {{ $schedule->sunday ? 'buttonActive' : '' }}">
                            <span id="span_sunday"
                                class="bg-[#09090b] rounded-full h-4 w-4 block duration-[0.15s] {{ $schedule->sunday ? 'checkboxActive' : '' }}"></span>
                        </button>
