...
<body class="bg-[#09090b] font-roboto grid grid-cols-[auto_1fr] border-[#27272a] min-h-screen">
    <nav
        class=" flex h-screen w-[250px] box-border py-6 px-4 bg-[#09090b] border rounded-md mx-3 my-6 border-[#27272a] text-[#fafafa] sticky top-0 self-start">
        <ul class="grow flex flex-col">
            ...
            <li>
                <button
                    ...
                    <svg class="flex-shrink-0" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        ...
                        stroke-linejoin="round" class="lucide lucide-chevron-down text-muted-foreground">
            ...
            <li class="mt-auto">
                ...
                <button
                    ...
                    <svg class="flex-shrink-0 rotate-180" xmlns="http://www.w3.org/2000/svg" width="24"
